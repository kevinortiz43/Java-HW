...
class UserInputHW3{
    public static void main(String args[]){
        ...
        int Digits = UserInput.length();
            System.out.println(Digits + " number of digits ");
        ...
        // this prints out the numbers seperaterly
            ...
            // String ToBeChecked = (String) Check.AtIndexOf(i)+ Check.AtIndexOf(i);
            // System.out.println(Integer.sum(Check, Check));
